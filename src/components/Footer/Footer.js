        ...
        <Grid container>
          <Grid item xs={6}>
            <Typography variant="body2" color="textPrimary" align="left">
              {'Copyright © Sct Finance '}
              {new Date().getFullYear()}
            </Typography>
          </Grid>
          <Grid item xs={6} style={{ textAlign: 'right' }}>
            <a
              href="https://mobile.twitter.com/sctsfinance"
            ...
            <a href="https://t.me/sctfinance" rel="noopener noreferrer" target="_blank" className={classes.link}>
            ...
            <a href="https://discord.gg/sctfinance" rel="noopener noreferrer" target="_blank" className={classes.link}>
